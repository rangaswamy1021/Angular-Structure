...
@Component({
  selector: 'app-sst-history',
  templateUrl: './sst-history.component.html',
  styleUrls: ['./sst-history.component.scss']
})
export class SstHistoryComponent
  implements OnInit {
  ...
  constructor( private materialscriptService: MaterialscriptService,private vioService: ViolatordetailsService, private tripContextService: TripsContextService, private sessionContext: SessionService, private violatorContext: ViolatorContextService, private router: Router, private commonService: CommonService) { }
 ...
 this.materialscriptService.material();
    ...
    userEvents.FeatureName = Features[Features.SSTHISTORY];
  ...
  bindSSTHistory() {
    ...
    this.vioService.getCitationHistory(this.tripsSearchRequest).subscribe(res => {
